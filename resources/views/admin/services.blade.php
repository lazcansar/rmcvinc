@extends('.theme')
@section('title'){{'Admin Hizmetler'}}@endsection
        ...
        <div class="container mx-auto">
            ...
            @endif
                ...
                @php
                    ...
                    $formAction = $isUpdating ? route('admin.service.update.post', $serviceFind->id) : route('admin.services');
                @endphp
            <h1 class="font-semibold text-2xl text-indigo-900 mb-4">{{ $isUpdating ? 'Hizmet Güncelle' : 'Hizmet Kaydet' }}</h1>
                    ...
                    @foreach($services as $service)
                        <tr class="border-b">
                            ...
                            <td class="px-3 py-4 text-sm text-gray-500">
                                <a href="{{ route('admin.service.delete', $service->id) }}" class="px-4 py-1 inline-block border bg-amber-900 text-white rounded-md hover:bg-amber-700"><i class="bi bi-trash"></i> Sil</a>
                                <a href="{{ route('admin.service.update', $service->id) }}" class="px-4 py-1 inline-block border bg-green-600 text-white rounded-md hover:bg-amber-700"><i class="bi bi-pencil-square"></i> Güncelle</a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
